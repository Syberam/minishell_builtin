...
/*   Updated: 2017/06/28 01:10:59 by sbonnefo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char					cd_step3(char *destpath, char **env);
char					cd_step4(char *destpath, char **env);
char					cd_step5(char *destpath, char **env, t_opt options);
char					cd_step6(char *destpath, char **env);
